...
export default function SignupForm() {
  ...
  const { signup, loading: authLoading, error: authError, clearError } = useAuthStore();
    ...
    <div className="w-full max-w-md mx-auto p-4 sm:p-6">
      <div className="glass rounded-2xl shadow-medium p-6 sm:p-8 border border-white/20 animate-fade-in">
        <div className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold gradient-text mb-2">新規登録</h1>
          <p className="text-sm text-slate-600">アカウントを作成して始めましょう</p>
        </div>
